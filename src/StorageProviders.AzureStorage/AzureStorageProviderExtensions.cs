...
public static class AzureStorageProviderExtensions
{
    extension(IServiceCollection services)
    {
        ...
        /// </remarks>
        public IServiceCollection AddAzureStorage(Action<AzureStorageSettings> optionsAction)
        {
        ...
        /// </remarks>
        public IServiceCollection AddAzureStorage(Action<IServiceProvider, AzureStorageSettings> optionsAction)
        {
            ArgumentNullException.ThrowIfNull(services);
            ArgumentNullException.ThrowIfNull(optionsAction);
